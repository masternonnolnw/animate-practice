...
export default function StyledWithoutDrag() {
  ...
  return (
    <div className="cards-wrapper min-h-screen">
      {CARDS.map((card) => (
...
const CARDS = [
  ...
  {
    title: "Pirates",
    subtitle: "The Pirate's Adventure",
  ...
  {
    title: "Knights",
    subtitle: "The Knight's Quest",
    description: "A game about knights",
    longDescription:
      "A game about knights, where you can play as a knight and fight other knights. You can also build your own castle and explore the world.",
    image: "https://picsum.photos/200",
    logo: "https://picsum.photos/200",
  },
];
